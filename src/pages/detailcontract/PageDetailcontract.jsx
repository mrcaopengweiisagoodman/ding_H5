    ...
    render() {
        ...
        if (detailData) {
           ...
           /* let a = [
            ...
            let childIds = detailData.cids.split(',');
            let childNamesCom = detailData.childNames.map((v,i) => {
                return  <div className="listHeight flex_bc">
                            <span className="leftName textOverflow_1">{v}</span>
                            <div className="flex_ec paySelect" onClick={() => this.goDetailContract(`${childIds[i]}`)}>
